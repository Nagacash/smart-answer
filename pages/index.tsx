    ...
    <div className="flex max-w-5xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 mt-2 sm:my-16">
        <h1 className="sm:text-4xl text-2xl max-w-1xl font-bold text-slate-900">
          Get your <span className="bg-gradient-to-r from-rose-400 via-fuchsia-500 to-indigo-500 bg-clip-text text-transparent">Answers</span> in seconds
        </h1>
        <p className="text-slate-500 my-5">10,345 answers generated already.</p>
        <div className="max-w-xl w-full">
          ...
          <div className="md:flex sm:mt-6 mt-4 space-y-4 md:space-y-0 gap-4">
            ...
            <a href="https://naga-coins.com/" className="bg-white block md:flex-1 border border-gray-300 rounded-xl text-black font-medium px-4 py-2 hover:bg-gradient-to-r hover:text-white transition-colors  duration-300 from-rose-400 via-fuchsia-500 to-indigo-500 w-full">
               Get Your Naga Gear &rarr;
            </a>
          </div>
        </div>
        <Toaster
        ...
        { error && (
          <p className="text-gray-400 my-5">🚨 Server error, please try again later, or you can <a href="https://naga-coins.com" className=" underline hover:text-black">contact us</a>. </p>
        )}
        <div className="mt-2">
          <a href="https://twitter.com/intent/tweet/?text=Smart%20Answer&url=https%3A%2F%2Fwww.naga-coins.com" target="_blank" className="text-[#1da1f2] font-medium text-sm px-5 py-2.5 text-center inline-flex items-center hover:opacity-80">
        ...
        <div className="my-5 max-w-xl w-full">
          ...
          <ul className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
            ...
            {/* <li className="">
              <a href="https://naga-coins.com" className="flex px-2 items-center justify-center text-center h-14 hover:bg-slate-100 rounded-lg hover:transition-all border border-dashed border-slate-200 bg-slate-50">
                <p className="h-6 leading-6">  <img className="h-6 object-contain"src="./Naga.png" alt="Naga Appparel" /></p>
              </a>
            </li> */}
          </ul>
        </div>
